...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.show_button.setGeometry(QtCore.QRect(80, 260, 151, 71))
        font = QtGui.QFont()
        ...
        self.hide_button.setGeometry(QtCore.QRect(350, 260, 151, 71))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.hide_button.setFont(font)
        self.hide_button.setObjectName("hide_button")
        self.textEdit = QtWidgets.QTextEdit(self.centralwidget)
        self.textEdit.setGeometry(QtCore.QRect(80, 20, 421, 191))
